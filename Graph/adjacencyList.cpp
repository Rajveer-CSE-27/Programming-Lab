...
void addEdge(int vertex1, int vertex2, int vertices, vector<int> graph[]) {
...
void removeEdge(int vertex1, int vertex2, int vertices, vector<int> graph[]) {
	if(vertex1 < 0 or vertex1 >= vertices or vertex2 < 0 or vertex2 >= vertices) {
			cout << "Index out of bound";
			return;
	}
...
void printGraph(int vertices, vector<int> graph[]) {
